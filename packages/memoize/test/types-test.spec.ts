...
it('should maintain the types of the original function', () => {
  ...
  >();
  expectTypeOf<Parameters<typeof getLocation>>().toEqualTypeOf<
    Parameters<typeof memoized>
  >();
  expectTypeOf<ReturnType<typeof getLocation>>().toEqualTypeOf<
    ReturnType<typeof memoized>
  >();
});
...
it('should add a .clear function property', () => {
  ...
  // @ts-expect-error testing that memoized clear works
...
it('should type the equality function to based on the provided function', () => {
  ...
  expectTypeOf<EqualityFn<typeof add>>().toEqualTypeOf<
    (
      newArgs: Parameters<typeof add>,
      lastArgs: Parameters<typeof add>
    ) => boolean
  >();
  expectTypeOf<EqualityFn<typeof add>>().toEqualTypeOf<
...
it('should allow weaker equality function types', () => {
  ...
  // ✅ exact parameters of `add`
  {
    const isEqual = function (
      first: Parameters<typeof add>,
      second: Parameters<typeof add>
    ) {
      return true;
    };
